...
package sifive.blocks.ip.xilinx.vc707mig4gb
...
trait VC707MIG4GBIODDR extends Bundle {
...
trait VC707MIG4GBIOClocksReset extends Bundle {
  //inputs
...
class vc707mig4gb(implicit val p:Parameters) extends BlackBox
{
  val io = new Bundle with VC707MIG4GBIODDR
                      with VC707MIG4GBIOClocksReset {
    // User interface signals
